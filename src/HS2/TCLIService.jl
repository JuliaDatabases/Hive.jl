...
function OpenSession(c::TCLIServiceClientBase, req::TOpenSessionReq)
  ...
  writeMessageBegin(p, "OpenSession", MessageType.CALL, c.seqid)
  inp = OpenSession_args()
  set_field(inp, :req, req)
  write(p, inp)
  writeMessageEnd(p)
  flush(p.t)
  ...
  outp = read(p, TSTRUCT, OpenSession_result())
  readMessageEnd(p)
...
function CloseSession(c::TCLIServiceClientBase, req::TCloseSessionReq)
  p = c.p
  c.seqid = (c.seqid < (2^31-1)) ? (c.seqid+1) : 0
  writeMessageBegin(p, "CloseSession", MessageType.CALL, c.seqid)
  ...
  (fname, mtype, rseqid) = readMessageBegin(p)
  (mtype == MessageType.EXCEPTION) && throw(read(p, TSTRUCT, TApplicationException()))
  outp = read(p, TSTRUCT, CloseSession_result())
  readMessageEnd(p)
  (rseqid != c.seqid) && throw(TApplicationException(ApplicationExceptionType.BAD_SEQUENCE_ID, "response sequence id $rseqid did not match request ($(c.seqid))"))
  has_field(outp, :success) && (return get_field(outp, :success))
  throw(TApplicationException(ApplicationExceptionType.MISSING_RESULT, "retrieve failed: unknown result"))
...
function GetInfo(c::TCLIServiceClientBase, req::TGetInfoReq)
  p = c.p
  c.seqid = (c.seqid < (2^31-1)) ? (c.seqid+1) : 0
  writeMessageBegin(p, "GetInfo", MessageType.CALL, c.seqid)
  inp = GetInfo_args()
  set_field(inp, :req, req)
  write(p, inp)
  writeMessageEnd(p)
  ...
  (fname, mtype, rseqid) = readMessageBegin(p)
  (mtype == MessageType.EXCEPTION) && throw(read(p, TSTRUCT, TApplicationException()))
  outp = read(p, TSTRUCT, GetInfo_result())
  readMessageEnd(p)
  (rseqid != c.seqid) && throw(TApplicationException(ApplicationExceptionType.BAD_SEQUENCE_ID, "response sequence id $rseqid did not match request ($(c.seqid))"))
  has_field(outp, :success) && (return get_field(outp, :success))
  throw(TApplicationException(ApplicationExceptionType.MISSING_RESULT, "retrieve failed: unknown result"))
...
function ExecuteStatement(c::TCLIServiceClientBase, req::TExecuteStatementReq)
  p = c.p
  c.seqid = (c.seqid < (2^31-1)) ? (c.seqid+1) : 0
  writeMessageBegin(p, "ExecuteStatement", MessageType.CALL, c.seqid)
  ...
  (fname, mtype, rseqid) = readMessageBegin(p)
  (mtype == MessageType.EXCEPTION) && throw(read(p, TSTRUCT, TApplicationException()))
  outp = read(p, TSTRUCT, ExecuteStatement_result())
  readMessageEnd(p)
  (rseqid != c.seqid) && throw(TApplicationException(ApplicationExceptionType.BAD_SEQUENCE_ID, "response sequence id $rseqid did not match request ($(c.seqid))"))
  has_field(outp, :success) && (return get_field(outp, :success))
  throw(TApplicationException(ApplicationExceptionType.MISSING_RESULT, "retrieve failed: unknown result"))
...
function GetTypeInfo(c::TCLIServiceClientBase, req::TGetTypeInfoReq)
  p = c.p
  c.seqid = (c.seqid < (2^31-1)) ? (c.seqid+1) : 0
  writeMessageBegin(p, "GetTypeInfo", MessageType.CALL, c.seqid)
  ...
  (fname, mtype, rseqid) = readMessageBegin(p)
  (mtype == MessageType.EXCEPTION) && throw(read(p, TSTRUCT, TApplicationException()))
  outp = read(p, TSTRUCT, GetTypeInfo_result())
  readMessageEnd(p)
  (rseqid != c.seqid) && throw(TApplicationException(ApplicationExceptionType.BAD_SEQUENCE_ID, "response sequence id $rseqid did not match request ($(c.seqid))"))
  has_field(outp, :success) && (return get_field(outp, :success))
  throw(TApplicationException(ApplicationExceptionType.MISSING_RESULT, "retrieve failed: unknown result"))
...
function GetCatalogs(c::TCLIServiceClientBase, req::TGetCatalogsReq)
  p = c.p
  c.seqid = (c.seqid < (2^31-1)) ? (c.seqid+1) : 0
  writeMessageBegin(p, "GetCatalogs", MessageType.CALL, c.seqid)
  ...
  (fname, mtype, rseqid) = readMessageBegin(p)
  (mtype == MessageType.EXCEPTION) && throw(read(p, TSTRUCT, TApplicationException()))
  outp = read(p, TSTRUCT, GetCatalogs_result())
  readMessageEnd(p)
  (rseqid != c.seqid) && throw(TApplicationException(ApplicationExceptionType.BAD_SEQUENCE_ID, "response sequence id $rseqid did not match request ($(c.seqid))"))
  has_field(outp, :success) && (return get_field(outp, :success))
  throw(TApplicationException(ApplicationExceptionType.MISSING_RESULT, "retrieve failed: unknown result"))
...
function GetSchemas(c::TCLIServiceClientBase, req::TGetSchemasReq)
  p = c.p
  c.seqid = (c.seqid < (2^31-1)) ? (c.seqid+1) : 0
  writeMessageBegin(p, "GetSchemas", MessageType.CALL, c.seqid)
  inp = GetSchemas_args()
  set_field(inp, :req, req)
  write(p, inp)
  writeMessageEnd(p)
  ...
  (fname, mtype, rseqid) = readMessageBegin(p)
  (mtype == MessageType.EXCEPTION) && throw(read(p, TSTRUCT, TApplicationException()))
  outp = read(p, TSTRUCT, GetSchemas_result())
  readMessageEnd(p)
  (rseqid != c.seqid) && throw(TApplicationException(ApplicationExceptionType.BAD_SEQUENCE_ID, "response sequence id $rseqid did not match request ($(c.seqid))"))
  has_field(outp, :success) && (return get_field(outp, :success))
  throw(TApplicationException(ApplicationExceptionType.MISSING_RESULT, "retrieve failed: unknown result"))
...
function GetTables(c::TCLIServiceClientBase, req::TGetTablesReq)
  p = c.p
  c.seqid = (c.seqid < (2^31-1)) ? (c.seqid+1) : 0
  writeMessageBegin(p, "GetTables", MessageType.CALL, c.seqid)
  inp = GetTables_args()
  set_field(inp, :req, req)
  write(p, inp)
  writeMessageEnd(p)
  ...
  (fname, mtype, rseqid) = readMessageBegin(p)
  (mtype == MessageType.EXCEPTION) && throw(read(p, TSTRUCT, TApplicationException()))
  outp = read(p, TSTRUCT, GetTables_result())
  readMessageEnd(p)
  (rseqid != c.seqid) && throw(TApplicationException(ApplicationExceptionType.BAD_SEQUENCE_ID, "response sequence id $rseqid did not match request ($(c.seqid))"))
  has_field(outp, :success) && (return get_field(outp, :success))
  throw(TApplicationException(ApplicationExceptionType.MISSING_RESULT, "retrieve failed: unknown result"))
...
function GetTableTypes(c::TCLIServiceClientBase, req::TGetTableTypesReq)
  p = c.p
  c.seqid = (c.seqid < (2^31-1)) ? (c.seqid+1) : 0
  writeMessageBegin(p, "GetTableTypes", MessageType.CALL, c.seqid)
  ...
  (fname, mtype, rseqid) = readMessageBegin(p)
  (mtype == MessageType.EXCEPTION) && throw(read(p, TSTRUCT, TApplicationException()))
  outp = read(p, TSTRUCT, GetTableTypes_result())
  readMessageEnd(p)
  (rseqid != c.seqid) && throw(TApplicationException(ApplicationExceptionType.BAD_SEQUENCE_ID, "response sequence id $rseqid did not match request ($(c.seqid))"))
  has_field(outp, :success) && (return get_field(outp, :success))
  throw(TApplicationException(ApplicationExceptionType.MISSING_RESULT, "retrieve failed: unknown result"))
...
function GetColumns(c::TCLIServiceClientBase, req::TGetColumnsReq)
  p = c.p
  c.seqid = (c.seqid < (2^31-1)) ? (c.seqid+1) : 0
  writeMessageBegin(p, "GetColumns", MessageType.CALL, c.seqid)
  inp = GetColumns_args()
  set_field(inp, :req, req)
  write(p, inp)
  writeMessageEnd(p)
  ...
  (fname, mtype, rseqid) = readMessageBegin(p)
  (mtype == MessageType.EXCEPTION) && throw(read(p, TSTRUCT, TApplicationException()))
  outp = read(p, TSTRUCT, GetColumns_result())
  readMessageEnd(p)
  (rseqid != c.seqid) && throw(TApplicationException(ApplicationExceptionType.BAD_SEQUENCE_ID, "response sequence id $rseqid did not match request ($(c.seqid))"))
  has_field(outp, :success) && (return get_field(outp, :success))
  throw(TApplicationException(ApplicationExceptionType.MISSING_RESULT, "retrieve failed: unknown result"))
...
function GetFunctions(c::TCLIServiceClientBase, req::TGetFunctionsReq)
  p = c.p
  c.seqid = (c.seqid < (2^31-1)) ? (c.seqid+1) : 0
  writeMessageBegin(p, "GetFunctions", MessageType.CALL, c.seqid)
  ...
  (fname, mtype, rseqid) = readMessageBegin(p)
  (mtype == MessageType.EXCEPTION) && throw(read(p, TSTRUCT, TApplicationException()))
  outp = read(p, TSTRUCT, GetFunctions_result())
  readMessageEnd(p)
  (rseqid != c.seqid) && throw(TApplicationException(ApplicationExceptionType.BAD_SEQUENCE_ID, "response sequence id $rseqid did not match request ($(c.seqid))"))
  has_field(outp, :success) && (return get_field(outp, :success))
  throw(TApplicationException(ApplicationExceptionType.MISSING_RESULT, "retrieve failed: unknown result"))
...
function GetOperationStatus(c::TCLIServiceClientBase, req::TGetOperationStatusReq)
  p = c.p
  c.seqid = (c.seqid < (2^31-1)) ? (c.seqid+1) : 0
  writeMessageBegin(p, "GetOperationStatus", MessageType.CALL, c.seqid)
  ...
  (fname, mtype, rseqid) = readMessageBegin(p)
  (mtype == MessageType.EXCEPTION) && throw(read(p, TSTRUCT, TApplicationException()))
  outp = read(p, TSTRUCT, GetOperationStatus_result())
  readMessageEnd(p)
  (rseqid != c.seqid) && throw(TApplicationException(ApplicationExceptionType.BAD_SEQUENCE_ID, "response sequence id $rseqid did not match request ($(c.seqid))"))
  has_field(outp, :success) && (return get_field(outp, :success))
  throw(TApplicationException(ApplicationExceptionType.MISSING_RESULT, "retrieve failed: unknown result"))
...
function CancelOperation(c::TCLIServiceClientBase, req::TCancelOperationReq)
  p = c.p
  c.seqid = (c.seqid < (2^31-1)) ? (c.seqid+1) : 0
  writeMessageBegin(p, "CancelOperation", MessageType.CALL, c.seqid)
  ...
  (fname, mtype, rseqid) = readMessageBegin(p)
  (mtype == MessageType.EXCEPTION) && throw(read(p, TSTRUCT, TApplicationException()))
  outp = read(p, TSTRUCT, CancelOperation_result())
  readMessageEnd(p)
  (rseqid != c.seqid) && throw(TApplicationException(ApplicationExceptionType.BAD_SEQUENCE_ID, "response sequence id $rseqid did not match request ($(c.seqid))"))
  has_field(outp, :success) && (return get_field(outp, :success))
  throw(TApplicationException(ApplicationExceptionType.MISSING_RESULT, "retrieve failed: unknown result"))
...
function CloseOperation(c::TCLIServiceClientBase, req::TCloseOperationReq)
  p = c.p
  c.seqid = (c.seqid < (2^31-1)) ? (c.seqid+1) : 0
  writeMessageBegin(p, "CloseOperation", MessageType.CALL, c.seqid)
  ...
  (fname, mtype, rseqid) = readMessageBegin(p)
  (mtype == MessageType.EXCEPTION) && throw(read(p, TSTRUCT, TApplicationException()))
  outp = read(p, TSTRUCT, CloseOperation_result())
  readMessageEnd(p)
  (rseqid != c.seqid) && throw(TApplicationException(ApplicationExceptionType.BAD_SEQUENCE_ID, "response sequence id $rseqid did not match request ($(c.seqid))"))
  has_field(outp, :success) && (return get_field(outp, :success))
  throw(TApplicationException(ApplicationExceptionType.MISSING_RESULT, "retrieve failed: unknown result"))
...
function GetResultSetMetadata(c::TCLIServiceClientBase, req::TGetResultSetMetadataReq)
  p = c.p
  c.seqid = (c.seqid < (2^31-1)) ? (c.seqid+1) : 0
  writeMessageBegin(p, "GetResultSetMetadata", MessageType.CALL, c.seqid)
  ...
  (fname, mtype, rseqid) = readMessageBegin(p)
  (mtype == MessageType.EXCEPTION) && throw(read(p, TSTRUCT, TApplicationException()))
  outp = read(p, TSTRUCT, GetResultSetMetadata_result())
  readMessageEnd(p)
  (rseqid != c.seqid) && throw(TApplicationException(ApplicationExceptionType.BAD_SEQUENCE_ID, "response sequence id $rseqid did not match request ($(c.seqid))"))
  has_field(outp, :success) && (return get_field(outp, :success))
  throw(TApplicationException(ApplicationExceptionType.MISSING_RESULT, "retrieve failed: unknown result"))
...
function FetchResults(c::TCLIServiceClientBase, req::TFetchResultsReq)
  p = c.p
  c.seqid = (c.seqid < (2^31-1)) ? (c.seqid+1) : 0
  writeMessageBegin(p, "FetchResults", MessageType.CALL, c.seqid)
  ...
  (fname, mtype, rseqid) = readMessageBegin(p)
  (mtype == MessageType.EXCEPTION) && throw(read(p, TSTRUCT, TApplicationException()))
  outp = read(p, TSTRUCT, FetchResults_result())
  readMessageEnd(p)
  (rseqid != c.seqid) && throw(TApplicationException(ApplicationExceptionType.BAD_SEQUENCE_ID, "response sequence id $rseqid did not match request ($(c.seqid))"))
  has_field(outp, :success) && (return get_field(outp, :success))
  throw(TApplicationException(ApplicationExceptionType.MISSING_RESULT, "retrieve failed: unknown result"))
...
function GetDelegationToken(c::TCLIServiceClientBase, req::TGetDelegationTokenReq)
  p = c.p
  c.seqid = (c.seqid < (2^31-1)) ? (c.seqid+1) : 0
  writeMessageBegin(p, "GetDelegationToken", MessageType.CALL, c.seqid)
  ...
  (fname, mtype, rseqid) = readMessageBegin(p)
  (mtype == MessageType.EXCEPTION) && throw(read(p, TSTRUCT, TApplicationException()))
  outp = read(p, TSTRUCT, GetDelegationToken_result())
  readMessageEnd(p)
  (rseqid != c.seqid) && throw(TApplicationException(ApplicationExceptionType.BAD_SEQUENCE_ID, "response sequence id $rseqid did not match request ($(c.seqid))"))
  has_field(outp, :success) && (return get_field(outp, :success))
  throw(TApplicationException(ApplicationExceptionType.MISSING_RESULT, "retrieve failed: unknown result"))
...
function CancelDelegationToken(c::TCLIServiceClientBase, req::TCancelDelegationTokenReq)
  p = c.p
  c.seqid = (c.seqid < (2^31-1)) ? (c.seqid+1) : 0
  writeMessageBegin(p, "CancelDelegationToken", MessageType.CALL, c.seqid)
  ...
  (fname, mtype, rseqid) = readMessageBegin(p)
  (mtype == MessageType.EXCEPTION) && throw(read(p, TSTRUCT, TApplicationException()))
  outp = read(p, TSTRUCT, CancelDelegationToken_result())
  readMessageEnd(p)
  (rseqid != c.seqid) && throw(TApplicationException(ApplicationExceptionType.BAD_SEQUENCE_ID, "response sequence id $rseqid did not match request ($(c.seqid))"))
  has_field(outp, :success) && (return get_field(outp, :success))
  throw(TApplicationException(ApplicationExceptionType.MISSING_RESULT, "retrieve failed: unknown result"))
...
function RenewDelegationToken(c::TCLIServiceClientBase, req::TRenewDelegationTokenReq)
  p = c.p
  c.seqid = (c.seqid < (2^31-1)) ? (c.seqid+1) : 0
  writeMessageBegin(p, "RenewDelegationToken", MessageType.CALL, c.seqid)
  ...
  (fname, mtype, rseqid) = readMessageBegin(p)
  (mtype == MessageType.EXCEPTION) && throw(read(p, TSTRUCT, TApplicationException()))
  outp = read(p, TSTRUCT, RenewDelegationToken_result())
  readMessageEnd(p)
  (rseqid != c.seqid) && throw(TApplicationException(ApplicationExceptionType.BAD_SEQUENCE_ID, "response sequence id $rseqid did not match request ($(c.seqid))"))
  has_field(outp, :success) && (return get_field(outp, :success))
  throw(TApplicationException(ApplicationExceptionType.MISSING_RESULT, "retrieve failed: unknown result"))
